...
@Component public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    /**
     * Creates a new RecipeBootstrap object.
     *
     * @param  categoryRepository
     * @param  recipeRepository
     * @param  unitOfMeasureRepository
     */
    public RecipeBootstrap(final CategoryRepository categoryRepository, final RecipeRepository recipeRepository,
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2),
